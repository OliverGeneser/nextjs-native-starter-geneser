...
export const PROD_URL_NO_HTTPS = 'nextjs-native-starter-geneser-app.vercel.app'
...
export const REDIRECT_URL = !IS_IN_PRODUCTION_ENVIRONMENT
  ? FRONTEND_URL
  : 'https://nextjs-native-starter-geneser-app-git-main-olivergeneser.vercel.app'
...
export const ALLOWED_CORS_URLS = [
  ...
  'https://nextjs-native-geneser-git-main-olivergeneser.vercel.app',
  'http://localhost',
]
